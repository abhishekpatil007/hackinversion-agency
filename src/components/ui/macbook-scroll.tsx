...
export const MacbookScroll = ({
  ...
  return (
    <div
      ref={ref}
      className="flex min-h-[150vh] shrink-0 scale-[0.5] transform flex-col items-center justify-start py-0 [perspective:800px] sm:scale-75 md:scale-100 md:py-40"
    >
      <motion.h2
        style={{
...
export const Keypad = () => {
  return (
    <div className="flex h-full w-full flex-col items-center justify-end gap-[2px] p-[0.5px]">
      {/* first Row */}
      ...
      <div className="mb-[2px] flex w-full shrink-0 gap-[2px]">
        ...
        <KBtn className="w-[3.65rem]" childrenClassName="h-full justify-between py-[4px]">
          <div className="flex w-full justify-end pr-1">
      ...
      {/* fourth Row */}
      <div className="mb-[2px] flex w-full shrink-0 gap-[2px]">
        <KBtn className="w-[4.2rem]" childrenClassName="h-full justify-between py-[4px]">
          <div className="flex w-full justify-end pr-1">
      ...
      {/* fifth Row */}
      <div className="mb-[2px] flex w-full shrink-0 gap-[2px]">
        <KBtn className="w-[5.2rem]" childrenClassName="h-full justify-between py-[4px]">
          <div className="flex w-full justify-end pr-1">
...
export const Trackpad = () => {
  return (
    <div className="absolute inset-x-0 bottom-0 mx-auto h-32 w-[40%] rounded-[3px] bg-[#0A090D]"></div>
  );
};
